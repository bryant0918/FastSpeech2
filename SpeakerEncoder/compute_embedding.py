...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default="pretrained_model/Muellers/best_model.pth.tar", required=False)
    parser.add_argument('--config_path', type=str, default="pretrained_model/Muellers/config.json", required=False)
