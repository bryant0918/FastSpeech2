...
def evaluate(model, discriminator, step, configs, logger=None, vocoder=None):
    ...
    message = ("Validation Step {}, Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, "
            "Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Duration Loss: {:.4f}, Prosody Loss: {:.4f}, "
            "Word Loss: {:.4f}, Full Duration Loss: {:.4f}, G Loss: {:.4f}, Prosody Reg: {:.4f}, "
            "NPC Loss: {:.4f}, D Loss: {:.4f}"
            ).format(*([train_step] + [l for l in loss_means]))
