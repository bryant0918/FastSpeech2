...
from .modules import VarianceAdaptor, NPC, BatchNorm
from utils.tools import get_mask_from_lengths

class EmotivBeta(nn.Module):
    """ EmotivBeta: Double parameter size of FastSpeech2Pros from 64M to 128M """

    def __init__(self, preprocess_config, model_config, pretrain=False):
        super(EmotivBeta, self).__init__()
