...
class PerceptualLoss(nn.Module):
    ...
    def forward(self, reconstructed_audio, synthesized_audio, sr, hop_length):
        reconstructed_embeddings = torchcrepe.embed(reconstructed_audio, sr, hop_length)
        synthesized_embeddings = torchcrepe.embed(synthesized_audio, sr, hop_length)
        perceptual_loss = self.criterion(reconstructed_embeddings, synthesized_embeddings)
